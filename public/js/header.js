$(function(){
    ...
    function slide(e){
        e.preventDefault()
        $(".navbar_header, .content").addClass('pagePush').removeClass('pagePushBack')//on ajoute des class qui utilise une animation personalisé
    ...
    function slideBack(e){
        e.preventDefault()
        $(".navbar_header, .content").removeClass('pagePush').addClass('pagePushBack')
